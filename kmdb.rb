...
# NOTE: The following Rails generator commands should be run in the terminal
...
actors_in_all_three = Actor.joins(:roles).group("actors.id").having("COUNT(DISTINCT roles.movie_id) = ?", Movie.count)
for actor in actors_in_all_three
  puts actor["name"]
end